...
enum class BannerColor(val material: Material) {
  BLACK(BLACK_BANNER), BLUE(BLUE_BANNER), BROWN(BROWN_BANNER), CYAN(CYAN_BANNER), GRAY(GRAY_BANNER), GREEN(GREEN_BANNER), LIGHT_BLUE(LIGHT_BLUE_BANNER),
  LIME(LIME_BANNER), MAGENTA(MAGENTA_BANNER), ORANGE(ORANGE_BANNER), PINK(PINK_BANNER), PURPLE(PURPLE_BANNER), RED(RED_BANNER),
  WHITE(WHITE_BANNER), YELLOW(YELLOW_BANNER)
}
